...
public class ObjectRendererUtilsTest {
    ...
    public void testCheckActionTagInternalUse_internalUsage_once() {
        ...
        boolean result = ObjectRendererUtils.checkActionTag(tagToCheck, ClientConnectionContext.createDeprecated());
    ...
    public void testCheckActionTagInternalUse_externalUsage_multiThread() throws InterruptedException {
        ...
        for (int i = 0; i <= maxIndex; i++) {
            ...
            executorService.submit(new Runnable() {
                @Override
                public void run() {
                    boolean result = ObjectRendererUtils.checkActionTag(tagToCheckexternalUsage, ClientConnectionContext.createDeprecated());
    ...
    public void testCheckActionTagInternalUse_externalUsage_internalUsage_multiThread() throws InterruptedException {
        ...
        for (int i = 0; i <= maxIndex; i++) {
            ...
            executorService.submit(new Runnable() {
                @Override
                public void run() {
                    boolean result = ObjectRendererUtils.checkActionTag(tagToCheckinternalUsage, ClientConnectionContext.createDeprecated());
