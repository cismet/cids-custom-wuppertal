 ...
 * @author  hell
 */
public class BebauungsplanVerfahrenfeatureRenderer extends CustomCidsFeatureRenderer {
    ...
    public BebauungsplanVerfahrenfeatureRenderer() {
        log.debug("BebauungsplanVerfahrenfeatureRenderer Verkennis 16.10.2008"+status+" "+nummer+" "+qualitaet);
        initComponents();
        setOpaque(false);
                ...
                try {
                    ...
                    EventQueue.invokeLater(new Runnable() {
                        ...
                        public void run() {
                            ...
                            BebauungsplanVerfahrenfeatureRenderer.this.setPreferredSize(new Dimension(icon.getIconWidth(), icon.getIconHeight()));
                            BebauungsplanVerfahrenfeatureRenderer.this.setSize(new Dimension(icon.getIconWidth(), icon.getIconHeight()));
                            revalidate();
...
//        //((TitledBorder)getBorder()).setTitle(title);
    ...
    public Paint getFillingStyle() {
        ...
        if (status == null) {return new Color(0, 0, 0, 255);}
        else {
        if (status.equals("rechtskräftig")) {
            return new Color(255, 255, 1, 50);
        }
    ...
    public Stroke getLineStyle() {
        ...
        if (qualitaet == null){ return new BasicStroke(20.0f);}
        else {
