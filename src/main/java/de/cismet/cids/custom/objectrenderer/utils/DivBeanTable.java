 ...
 */
public class DivBeanTable extends AbstractTableModel {

    //~ Static fields/initializers ---------------------------------------------

    private static final Logger LOG = Logger.getLogger(DivBeanTable.class);
    ...
    /**
     * Creates a new EmobBeanTable object.
     *
     ...
     */
    public DivBeanTable(final boolean editable,
            final CidsBean bean,
