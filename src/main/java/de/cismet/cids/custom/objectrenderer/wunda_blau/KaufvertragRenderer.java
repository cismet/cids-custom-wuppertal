 ...
 * 
 * Renderer speziell fuer Kaufvertraege und deren Unterklassen.
 * 
 * @author nhaffke
 */
...
//    public Timestamp verkaufsdatTo = null;
    ...
    public void assignSingle() {
        ...
        if (verkaufsdatFrom != null)
            lblVerkaufsdat.setText(DateFormat.getDateInstance(DateFormat.SHORT, Locale.GERMANY).format(verkaufsdatFrom));
        else {
    ...
    private void initComponents() {
        ...
        javax.swing.GroupLayout panSachwerteLayout = new javax.swing.GroupLayout(panSachwerte);
        panSachwerte.setLayout(panSachwerteLayout);
        panSachwerteLayout.setHorizontalGroup(
            panSachwerteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panSachwerteLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panSachwerteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(panSachwerteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblSachKaufpreis)
                    .addComponent(lblSachRohertrag)
                    .addComponent(lblSachKaufpreisRoh)
                    .addComponent(lblSachMarktanp)
                    .addComponent(lblSachZinssatz))
        ...
        panSachwerteLayout.setVerticalGroup(
            ...
            .addGroup(panSachwerteLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panSachwerteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel13)
                    .addComponent(lblSachRohertrag))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panSachwerteLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        javax.swing.GroupLayout panFlurstueckeLayout = new javax.swing.GroupLayout(panFlurstuecke);
        panFlurstuecke.setLayout(panFlurstueckeLayout);
        panFlurstueckeLayout.setHorizontalGroup(
            panFlurstueckeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        javax.swing.GroupLayout panGebaeudeLayout = new javax.swing.GroupLayout(panGebaeude);
        panGebaeude.setLayout(panGebaeudeLayout);
        panGebaeudeLayout.setHorizontalGroup(
            panGebaeudeLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        javax.swing.GroupLayout panTeileigentumLayout = new javax.swing.GroupLayout(panTeileigentum);
        panTeileigentum.setLayout(panTeileigentumLayout);
        panTeileigentumLayout.setHorizontalGroup(
            panTeileigentumLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        panMainLayout.setHorizontalGroup(
            ...
            .addGroup(panMainLayout.createSequentialGroup()
                ...
                .addGap(38, 38, 38)
                .addGroup(panMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(panTeileigentum, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(panGebaeude, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(panFlurstuecke, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblAuswertung)
                    .addComponent(lblKaufpreisAbs)
                    .addComponent(lblKaufpreisQm)
                    .addComponent(lblGesamtteilflaeche)
                    .addComponent(lblObjektart)
                    .addComponent(panSachwerte, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblRegJahr)
                    .addComponent(lblAdresse)
                    .addComponent(lblRegBez)
                    .addComponent(lblGesamtflaeche)
                    .addComponent(lblTeilmarkt)
                    .addComponent(lblVerkaufsdat))
        ...
        panMainLayout.setVerticalGroup(
            ...
            .addGroup(panMainLayout.createSequentialGroup()
                ...
                .addGroup(panMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel18)
                    .addComponent(panFlurstuecke, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel19)
                    .addComponent(panGebaeude, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panMainLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel20)
                    .addComponent(panTeileigentum, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private RoundedPanel createFlurstueckPanel(int i) {
        ...
        if (flurNr.size() > i && flurNr.get(i) != null && !flurNr.get(i).equals("") && !flurNr.get(i).equals("null")) {
    ...
    private RoundedPanel createTeileigentumPanel(int i) {
        ...
        if (eigVermietung.size() > i && eigVermietung.get(i) != null && !eigVermietung.get(i).equals("") && !eigVermietung.get(i).equals("null")) {
            teil.add(vermietung);
        ...
        if (eigAusstattung.size() > i && eigAusstattung.get(i) != null && !eigAusstattung.get(i).equals("") && !eigAusstattung.get(i).equals("null")) {
        ...
        if (eigWohnlage.size() > i && eigWohnlage.get(i) != null && !eigWohnlage.get(i).equals("") && !eigWohnlage.get(i).equals("null")) {
            teil.add(wohnlage);
