...
public class Sb_stadtbildserieAggregationRenderer extends javax.swing.JPanel implements RequestsFullSizeComponent,
    ...
    private de.cismet.cids.custom.objectrenderer.wunda_blau.Sb_stadtbildserieAggregationRendererInfoPanel infoNotAvailable;
    ...
    private void initComponents() {
        ...
        infoNotAvailable = new de.cismet.cids.custom.objectrenderer.wunda_blau.Sb_stadtbildserieAggregationRendererInfoPanel();
        ...
        org.openide.awt.Mnemonics.setLocalizedText(lblTitle, org.openide.util.NbBundle.getMessage(Sb_stadtbildserieAggregationRenderer.class, "Sb_stadtbildserieAggregationRenderer.lblTitle.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        tbtnSlide.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cids/custom/objectrenderer/wunda_blau/arrow.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(tbtnSlide, org.openide.util.NbBundle.getMessage(Sb_stadtbildserieAggregationRenderer.class, "Sb_stadtbildserieAggregationRenderer.tbtnSlide.text")); // NOI18N
        tbtnSlide.setBorderPainted(false);
        tbtnSlide.setContentAreaFilled(false);
        tbtnSlide.setFocusPainted(false);
        tbtnSlide.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cids/custom/objectrenderer/wunda_blau/arrow-180.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cids/custom/objectrenderer/wunda_blau/image_small.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(Sb_stadtbildserieAggregationRenderer.class, "Sb_stadtbildserieAggregationRenderer.jLabel1.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cids/custom/objectrenderer/wunda_blau/image_big.png"))); // NOI18N
        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(Sb_stadtbildserieAggregationRenderer.class, "Sb_stadtbildserieAggregationRenderer.jLabel2.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
...
//        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
//
//        roundedPanel1.setMinimumSize(new Dimension(Math.round(this.getSize().width), 0));
//        roundedPanel1.setPreferredSize(new Dimension(Math.round(this.getSize().width), 0));
//
//        remove(roundedPanel1);
//        add(roundedPanel1, gridBagConstraints);
//        gridBagConstraints = ((GridBagLayout)this.getLayout()).getConstraints(infoPanel);
//        remove(infoPanel);
//        add(infoPanel,gridBagConstraints);
//        this.revalidate();

//
//        final Dimension size = infoPanel.getSize();
//
//        final Point location = infoPanel.getLocation();
//        final Component parent = infoPanel.getParent();
////        location = SwingUtilities.convertPoint(parent, location, this);
//
//        final Rectangle from = new Rectangle(location.x, location.y, size.width, size.height);
//        final Rectangle to = new Rectangle(from.x + (Math.round(size.width * 0.9f)),
//                location.y,
//                size.width,
//                size.height);
//
...
// do nothing
    ...
    public class Animate {
         ...
         * @param  to     DOCUMENT ME!
         */
        public Animate(final JPanel panel, final Rectangle from, final Rectangle to) {
            this.panel = panel;
            this.from = from;
            this.to = to;
        }
            ...
            final Timer timer = new Timer(40, new ActionListener() {
                        ...
                        public void actionPerformed(final ActionEvent e) {
                            ...
                            if (progress > 1f) {
                                ...
                                Sb_stadtbildserieAggregationRenderer.this.doLayout();
                            }
                            final Rectangle target = calculateProgress(from, to, progress);
         ...
         * DOCUMENT ME!
         *
         * @param   startBounds   DOCUMENT ME!
         * @param   targetBounds  DOCUMENT ME!
         * @param   progress      DOCUMENT ME!
         *
         * @return  DOCUMENT ME!
         */
        public Rectangle calculateProgress(final Rectangle startBounds,
         ...
         * DOCUMENT ME!
         *
         * @param   startPoint   DOCUMENT ME!
         * @param   targetPoint  DOCUMENT ME!
         * @param   progress     DOCUMENT ME!
         *
         * @return  DOCUMENT ME!
         */
        public Point calculateProgress(final Point startPoint, final Point targetPoint, final double progress) {
         ...
         * @param   endValue    DOCUMENT ME!
         * @param   fraction    DOCUMENT ME!
         *
         * @return  DOCUMENT ME!
         */
        public int calculateProgress(final int startValue, final int endValue, final double fraction) {
            int value = 0;
            final int distance = endValue - startValue;
         ...
         * DOCUMENT ME!
         *
         * @param   startSize   DOCUMENT ME!
         * @param   targetSize  DOCUMENT ME!
         * @param   progress    DOCUMENT ME!
         *
         * @return  DOCUMENT ME!
         */
        public Dimension calculateProgress(final Dimension startSize,
