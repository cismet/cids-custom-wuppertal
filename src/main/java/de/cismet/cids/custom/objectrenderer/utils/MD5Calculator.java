...
public final class MD5Calculator {
    ...
    public static String generateMD5(File inputFile) throws NoSuchAlgorithmException, IOException {
    ...
    public static String generateMD5(String filename) throws NoSuchAlgorithmException, IOException {
