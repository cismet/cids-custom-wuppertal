...
public class BillingPopup extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setBounds((screenSize.width - 546) / 2, (screenSize.height - 573) / 2, 546, 573);
    ...
    private void cmdOkActionPerformed(final java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdOkActionPerformed
        ...
        try {
            ...
            cb.setProperty("gebuehr", endPrice);
...
//        cb.setProperty("geometrie", null);
    ...
    private void calculateEndPrice() {
        ...
        if (sel instanceof Usage) {
            ...
            berechungUsageDependent = "zweckabhängiger Rabatt: -" + absDiscount + " €\n";
            berechungUsageDependent += "---------\n";
            endPrice = rawPrice * discount;

            berechungUsageDependent += endPrice + "€\n";
    ...
    private void initialize(
        ...
        for (final ProductGroupAmount pga : amounts) {
            ...
            berechnungPrefix += (pga.getAmount() + " " + productGroups.get(pga.group).getDescription() + " (a "
                            + currentProduct.getPrices().get(pga.group) + " €)\n");
        }

        berechnungPrefix += "---------\n";
        calculateRawPrice(product, amounts);
        berechnungPrefix += rawPrice + " €\n";
        berechnungPrefix += "\n";
