...
public class Sb_stadtbildserieAggregationRendererInfoPanel extends javax.swing.JPanel implements ListSelectionListener,
     ...
     */
    private void btnSelectAllActionPerformed(final java.awt.event.ActionEvent evt) {                                              
        if (gridObject != null) {
     ...
     * @param  evt  DOCUMENT ME!
     */
    private void btnSelectNoneActionPerformed(final java.awt.event.ActionEvent evt) {                                               
        if (gridObject != null) {
     ...
     * @param  evt  DOCUMENT ME!
     */
    private void btnInvertSelectionActionPerformed(final java.awt.event.ActionEvent evt) {                                                    
        if (gridObject != null) {
