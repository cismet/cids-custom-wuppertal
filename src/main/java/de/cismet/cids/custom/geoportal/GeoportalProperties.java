 ...
 */
public class GeoportalProperties extends Properties {

    //~ Static fields/initializers ---------------------------------------------

    private static final org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(GeoportalProperties.class);
    ...
    /**
     * Creates a new GeoportalProperties object.
     */
    private GeoportalProperties() {
    }
    ...
    public int getRotationIndex() {
        try {
            ...
            LOG.warn("Geoportal Properties: Cannot parse rotation index");
            return 0;
        }
    }
    ...
    public int[] getHeadings() {
        ...
        LOG.warn("Geoportal Properties: Cannot parse headings. Use default values");
                ...
                if (splitted.length == 4) {
                    for (int i = 0; i < 4; ++i) {
                        ...
                        if (singleSpotValues.length == 2) {
                            ...
                            LOG.warn("Geoportal Properties: Cannot parse sweet spots. Use default values");
                            return new double[][] {
                                    { 1, 0 },
                                    { 1, 1 },
                                    { 0, 1 },
     ...
     * @return  DOCUMENT ME!
     */
    public static GeoportalProperties getInstance() {
        return GeoportalProperties.LazyInitialiser.INSTANCE;
    }
    ...
    private static final class LazyInitialiser {
        ...
        private static final GeoportalProperties INSTANCE = new GeoportalProperties();
    }
}
