 ...
 *
 * <p>Scrollable amounts can be specifed as a percentage of the viewport size or as an actual pixel value. The amount
 * can be changed for both unit and block scrolling for both horizontal and vertical scrollbars.</p>
 *
 * <p>The Scrollable interface only provides a boolean value for determining whether or not the viewport size (width or
