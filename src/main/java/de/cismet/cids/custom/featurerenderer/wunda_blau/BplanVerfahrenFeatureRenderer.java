 ...
 */
public class BplanVerfahrenFeatureRenderer extends CustomCidsFeatureRenderer {
    ...
    /**
     * Creates a new BplanVerfahrenFeatureRenderer object.
     */
    public BplanVerfahrenFeatureRenderer() {
                        ...
                        try {
                            ...
                            EventQueue.invokeLater(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        BplanVerfahrenFeatureRenderer.this.setPreferredSize(
                                            new Dimension(icon.getIconWidth(), icon.getIconHeight()));
                                        BplanVerfahrenFeatureRenderer.this.setSize(
                                            new Dimension(icon.getIconWidth(), icon.getIconHeight()));
                                        revalidate();
