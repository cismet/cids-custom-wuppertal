 ...
 */
public class BplanPlanFeatureRenderer extends CustomCidsFeatureRenderer {
    ...
    /**
     * Creates a new BplanPlanFeatureRenderer object.
     */
    public BplanPlanFeatureRenderer() {
                        ...
                        try {
                            ...
                            EventQueue.invokeLater(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        BplanPlanFeatureRenderer.this.setPreferredSize(
                                            new Dimension(icon.getIconWidth(), icon.getIconHeight()));
                                        BplanPlanFeatureRenderer.this.setSize(
                                            new Dimension(icon.getIconWidth(), icon.getIconHeight()));
                                        revalidate();
