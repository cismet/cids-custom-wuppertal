...
public class BusyLoggingTextPane extends JTextPane {
    ...
    public static void main(final String[] args) throws InterruptedException {
        ...
        final BusyLoggingTextPane textPane = new BusyLoggingTextPane(50, 50);
        textPane.setSize(400, 400);
        pnl.add(textPane, BorderLayout.CENTER);
        ...
        SwingUtilities.invokeLater(new Runnable() {
                ...
                public void run() {
                    try {
                        textPane.setBusy(true);
                        textPane.addMessage("Alle meine Entchen", Styles.INFO);
                        Thread.sleep(500);
                        textPane.addMessage("schwimmen auf dem See", Styles.TIP);
                        Thread.sleep(500);
                        textPane.addMessage("köpfchen in das wasser", Styles.SUCCESS);
                        Thread.sleep(500);
                        textPane.addMessage("schwänzchen in die höh", Styles.WARN);
                        Thread.sleep(500);
                        textPane.addMessage("sankt martin sankt martin", Styles.EXPERT);
                        Thread.sleep(500);
                        textPane.addMessage("sankt martin ritt durch schnee und wind", Styles.ERROR_REASON);
                        Thread.sleep(500);
                        textPane.addMessage("sein ross das trug ihn fort geschwind", Styles.ERROR);
                        Thread.sleep(500);

                        textPane.setBusy(false);
