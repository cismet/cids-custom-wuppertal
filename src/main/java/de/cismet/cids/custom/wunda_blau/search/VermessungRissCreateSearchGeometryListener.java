 ...
 */
public class VermessungRissCreateSearchGeometryListener extends AbstractCreateSearchGeometryListener {
    ...
    private void registerOnMappingComponent() {
        getMappingComponent().addCustomInputListener(VERMESSUNGRISS_CREATE_SEARCH_GEOMETRY, this);
        getMappingComponent().putCursor(VERMESSUNGRISS_CREATE_SEARCH_GEOMETRY, new Cursor(Cursor.CROSSHAIR_CURSOR));
    }
    ...
    public void propertyChange(final PropertyChangeEvent evt) {
        ...
        if (MappingComponent.PROPERTY_MAP_INTERACTION_MODE.equals(propertyName)) {
            if (VERMESSUNGRISS_CREATE_SEARCH_GEOMETRY.equals(newValue)) {
