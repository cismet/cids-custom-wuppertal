 ...
 */
public class TreppenSearchTooltip extends PNode {
    ...
    /**
     * Creates a new TreppenSearchTooltip object.
     *
     * @param  icoTreppe  DOCUMENT ME!
     */
    public TreppenSearchTooltip(final ImageIcon icoTreppe) {
        double leftMargin = 5;
        ...
        if ((icoTreppe != null) && (icoTreppe.getImage() != null)) {
            final PImage imgHeader = new PImage(icoTreppe.getImage());
            imgHeader.setOffset(offsetX, offsetY);

            offsetX += icoTreppe.getIconWidth() + 5;
            leftMargin = offsetX;
            totalWidth = offsetX;
        ...
        final PText lblHeader = new PText(NbBundle.getMessage(
                    TreppenSearchTooltip.class,
                    "TreppenSearchTooltip.TreppenSearchTooltip(ImageIcon).lblHeader"));
        ...
        final PText lblFilter = new PText(NbBundle.getMessage(
                    TreppenSearchTooltip.class,
                    "TreppenSearchTooltip.TreppenSearchTooltip(ImageIcon).lblFilter"));
