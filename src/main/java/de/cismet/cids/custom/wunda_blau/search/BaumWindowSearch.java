...
public class BaumWindowSearch extends javax.swing.JPanel implements CidsWindowSearch,
    ...
    public void initWithConnectionContext(final ConnectionContext connectionContext) {
        ...
        try {
            ...
            if (geoSearchEnabled) {
                final BaumCreateSearchGeometryListener geometryListener =
                    new BaumCreateSearchGeometryListener(mappingComponent,
    ...
    private void initComponents() {
        ...
        pnlAp.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(BaumWindowSearch.class, "BaumWindowSearch.pnlAp.border.title"))); // NOI18N
        ...
        lblStrasse.setText(org.openide.util.NbBundle.getMessage(BaumWindowSearch.class, "BaumWindowSearch.lblStrasse.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        txtStrasse.setText(org.openide.util.NbBundle.getMessage(BaumWindowSearch.class, "BaumWindowSearch.txtStrasse.text")); // NOI18N
        ...
        lblBemerkung.setText(org.openide.util.NbBundle.getMessage(BaumWindowSearch.class, "BaumWindowSearch.lblBemerkung.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        txtBemerkung.setText(org.openide.util.NbBundle.getMessage(BaumWindowSearch.class, "BaumWindowSearch.txtBemerkung.text")); // NOI18N
        ...
        pnlAp.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(BaumWindowSearch.class, "BaumWindowSearch.pnlAp.AccessibleContext.accessibleName")); // NOI18N
        ...
        cbMapSearch.setText(org.openide.util.NbBundle.getMessage(BaumWindowSearch.class, "BaumWindowSearch.cbMapSearch.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        ...
        lblFiller6.setText(org.openide.util.NbBundle.getMessage(BaumWindowSearch.class, "BaumWindowSearch.lblFiller6.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.gridwidth = 2;
