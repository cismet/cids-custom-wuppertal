 ...
 */
public class AlboFlaecheSearchTooltip extends PNode {
    ...
    /**
     * Creates a new AlboFlaecheSearchTooltip object.
     *
     * @param  icoAlbo  DOCUMENT ME!
     */
    public AlboFlaecheSearchTooltip(final ImageIcon icoAlbo) {
        double leftMargin = 5;
        ...
        if ((icoAlbo != null) && (icoAlbo.getImage() != null)) {
            final PImage imgHeader = new PImage(icoAlbo.getImage());
            imgHeader.setOffset(offsetX, offsetY);

            offsetX += icoAlbo.getIconWidth() + 5;
            leftMargin = offsetX;
            totalWidth = offsetX;
        ...
        final PText lblHeader = new PText("Altlasten-Suche");
        ...
        final PText lblFilter = new PText(
                "Es gelten die im Fenster \"Altlasten-Suche\" eingestellten Filterbedingungen!");
