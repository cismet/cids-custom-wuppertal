 ...
 */
public class VermessungRissSearchTooltip extends PNode {

    //~ Static fields/initializers ---------------------------------------------

    private static final Logger LOG = Logger.getLogger(VermessungRissSearchTooltip.class);
     ...
     *
     * @param  icoVermessungRiss  searchTopics DOCUMENT ME!
     */
    public VermessungRissSearchTooltip(final ImageIcon icoVermessungRiss) {
        double leftMargin = 5;
        ...
        if ((icoVermessungRiss != null) && (icoVermessungRiss.getImage() != null)) {
            final PImage imgHeader = new PImage(icoVermessungRiss.getImage());
            imgHeader.setOffset(offsetX, offsetY);

            offsetX += icoVermessungRiss.getIconWidth() + 5;
            leftMargin = offsetX;
            totalWidth = offsetX;
        ...
        final PText lblHeader = new PText(NbBundle.getMessage(
                    VermessungRissSearchTooltip.class,
                    "VermessungRissSearchTooltip.VermessungRissSearchTooltip(ImageIcon).lblHeader"));
        ...
        final PText lblFilter = new PText(NbBundle.getMessage(
                    VermessungRissSearchTooltip.class,
                    "VermessungRissSearchTooltip.VermessungRissSearchTooltip(ImageIcon).lblFilter"));
