 ...
 */
public class MauernSearchTooltip extends PNode {
    ...
    /**
     * Creates a new MauernSearchTooltip object.
     *
     * @param  icoMauer  DOCUMENT ME!
     */
    public MauernSearchTooltip(final ImageIcon icoMauer) {
        double leftMargin = 5;
        ...
        if ((icoMauer != null) && (icoMauer.getImage() != null)) {
            final PImage imgHeader = new PImage(icoMauer.getImage());
            imgHeader.setOffset(offsetX, offsetY);

            offsetX += icoMauer.getIconWidth() + 5;
            leftMargin = offsetX;
            totalWidth = offsetX;
        ...
        final PText lblHeader = new PText(NbBundle.getMessage(
                    MauernSearchTooltip.class,
                    "MauernSearchTooltip.MauernSearchTooltip(ImageIcon).lblHeader"));
        ...
        final PText lblFilter = new PText(NbBundle.getMessage(
                    MauernSearchTooltip.class,
                    "MauernSearchTooltip.MauernSearchTooltip(ImageIcon).lblFilter"));
