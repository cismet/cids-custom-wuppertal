...
public class AlkisWindowSearch extends javax.swing.JPanel implements CidsWindowSearch, ActionTagProtected, SearchControlListener {
...
//    }
    ...
    @Override
    public void searchDone(Node[] result) {
    }
