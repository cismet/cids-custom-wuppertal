 ...
 */
public class VzkatSearchTooltip extends PNode {
    ...
    /**
     * Creates a new VzkatSearchTooltip object.
     *
     * @param  icoVzkat  DOCUMENT ME!
     */
    public VzkatSearchTooltip(final ImageIcon icoVzkat) {
        double leftMargin = 5;
        ...
        if ((icoVzkat != null) && (icoVzkat.getImage() != null)) {
            final PImage imgHeader = new PImage(icoVzkat.getImage());
            imgHeader.setOffset(offsetX, offsetY);

            offsetX += icoVzkat.getIconWidth() + 5;
            leftMargin = offsetX;
            totalWidth = offsetX;
        ...
        final PText lblHeader = new PText("Verkehrszeichen-Suche");
        ...
        final PText lblFilter = new PText(
                "Es gelten die im Fenster \"Verkehrszeichen-Suche\" eingestellten Filterbedingungen!");
