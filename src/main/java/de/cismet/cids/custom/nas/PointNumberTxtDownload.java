 ...
 */
public class PointNumberTxtDownload extends AbstractDownload {
     ...
     */
    public PointNumberTxtDownload(final PointNumberReservationRequest content,
            final String title,
    ...
    public void run() {
        ...
        if (downloadProtokoll) {
            ...
            protokoll = content.createTxtProtokoll();
        }
