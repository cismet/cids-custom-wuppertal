 ...
 */
public class UaUnfallfolgenEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    BeforeSavingHook,
    SaveVetoable,
    ...
    private static final Logger LOG = Logger.getLogger(UaUnfallfolgenEditor.class);
    public static final String REDUNDANT_TOSTRING_TEMPLATE = "%s";
    public static final String[] REDUNDANT_TOSTRING_FIELDS = { "name", "id" };
    public static final String REDUNDANT_TABLE = "ua_unfallfolgen";
        
    public static final String FIELD__NAME = "name";  
    public static final String FIELD__ID = "id";                         
    public static final String TABLE_NAME = "ua_unfallfolgen";

    public static final String BUNDLE_NONAME = "UaUnfallfolgenEditor.isOkForSaving().noName";
    public static final String BUNDLE_DUPLICATENAME = "UaUnfallfolgenEditor.isOkForSaving().duplicateName";
    public static final String BUNDLE_PANE_PREFIX = "UaUnfallfolgenEditor.isOkForSaving().JOptionPane.message.prefix";
    public static final String BUNDLE_PANE_SUFFIX = "UaUnfallfolgenEditor.isOkForSaving().JOptionPane.message.suffix";
    public static final String BUNDLE_PANE_TITLE = "UaUnfallfolgenEditor.isOkForSaving().JOptionPane.title";
    private static String TITLE_NEW_FOLGE = "eine neue Unfallfolge anlegen...";
     ...
     * Creates new form.
     */
    public UaUnfallfolgenEditor() {
        this(true);
    }

    /**
     * Creates a new UaUnfallfolgenEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public UaUnfallfolgenEditor(final boolean boolEditor) {
    ...
    public void beforeSaving() {
        final RedundantObjectSearch folgeSearch = new RedundantObjectSearch(
        ...
        folgeSearch.setWhere(conditions);
        try {
            redundantName =
            ...
            LOG.warn("problem in check name unfallfolgen: load values.", e);
        }
    }
    ...
    public boolean isOkForSaving() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(UaUnfallfolgenEditor.class, BUNDLE_NONAME));
                save = false;
            } else {
                if (redundantName) {
                    LOG.warn("Duplicate name specified. Skip persisting.");
                    errorMessage.append(NbBundle.getMessage(UaUnfallfolgenEditor.class, BUNDLE_DUPLICATENAME));
                    save = false;
                }
            }
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(UaUnfallfolgenEditor.class,
                    BUNDLE_PANE_PREFIX)
