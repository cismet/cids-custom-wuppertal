 ...
 */
public class PoiCopyrightEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    SaveVetoable,
    RequestsFullSizeComponent {

    //~ Static fields/initializers ---------------------------------------------

    private static final Logger LOG = Logger.getLogger(PoiCopyrightEditor.class);
    public static final String FIELD__NAME = "name";
    public static final String FIELD__ID = "id";

    private static String TITLE_NEW_COPYRIGHT = "einen neuen Copyright Vermerk anlegen...";

    public static final String BUNDLE_NONAME = "PoiCopyrightEditor.isOkForSaving().noName";
    public static final String BUNDLE_PANE_PREFIX = "PoiCopyrightEditor.isOkForSaving().JOptionPane.message.prefix";
    public static final String BUNDLE_PANE_SUFFIX = "PoiCopyrightEditor.isOkForSaving().JOptionPane.message.suffix";
    public static final String BUNDLE_PANE_TITLE = "PoiCopyrightEditor.isOkForSaving().JOptionPane.title";
     ...
     * Creates new form.
     */
    public PoiCopyrightEditor() {
        this(true);
    }

    /**
     * Creates a new PoiCopyrightEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public PoiCopyrightEditor(final boolean boolEditor) {
    ...
    public boolean isOkForSaving() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(PoiCopyrightEditor.class, BUNDLE_NONAME));
                save = false;
            }
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(PoiCopyrightEditor.class,
                    BUNDLE_PANE_PREFIX)
                        + errorMessage.toString()
                        + NbBundle.getMessage(PoiCopyrightEditor.class,
                            BUNDLE_PANE_SUFFIX),
                NbBundle.getMessage(PoiCopyrightEditor.class, BUNDLE_PANE_TITLE),
