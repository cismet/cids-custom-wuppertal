 ...
 */
public class KlimaKategorieEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    EditorSaveListener,
    BindingGroupStore,
     ...
     * Creates new form.
     */
    public KlimaKategorieEditor() {
    }

    /**
     * Creates a new KlimaKategorieEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public KlimaKategorieEditor(final boolean boolEditor) {
    ...
    public boolean prepareForSave() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(KlimaKategorieEditor.class, BUNDLE_NONAME));
            } else {
                if (redundantName) {
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(KlimaKategorieEditor.class,
                    BUNDLE_PANE_PREFIX)
