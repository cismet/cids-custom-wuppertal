...
public class BaumFestsetzungPanel extends javax.swing.JPanel implements Disposable, CidsBeanStore, ConnectionContextProvider {
    ...
    private void initComponents() {
        ...
        lblArt = new JLabel();
        cbArtF = new DefaultBindableScrollableComboBox();
        lblGeom = new JLabel();
        if (isEditor){
        ...
        gridBagConstraints.fill = GridBagConstraints.HORIZONTAL;
        gridBagConstraints.weightx = 1.0;
        add(panFest, gridBagConstraints);
        ...
        panPreviewMap.setMinimumSize(new Dimension(100, 200));
        ...
        add(panGeometrie, gridBagConstraints);
