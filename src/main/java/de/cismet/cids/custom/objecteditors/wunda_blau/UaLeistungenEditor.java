 ...
 */
public class UaLeistungenEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    BeforeSavingHook,
    SaveVetoable,
    ...
    private static final Logger LOG = Logger.getLogger(UaLeistungenEditor.class);
    ...
    public static final String BUNDLE_DUPLICATENAME = "UaLeistungenEditor.isOkForSaving().duplicateName";
    public static final String BUNDLE_PANE_PREFIX = "UaLeistungenEditor.isOkForSaving().JOptionPane.message.prefix";
    public static final String BUNDLE_PANE_SUFFIX = "UaLeistungenEditor.isOkForSaving().JOptionPane.message.suffix";
    public static final String BUNDLE_PANE_TITLE = "UaLeistungenEditor.isOkForSaving().JOptionPane.title";
    private static String TITLE_NEW_LEISTUNG = "eine neue Leistung anlegen...";
     ...
     * Creates new form.
     */
    public UaLeistungenEditor() {
        this(true);
    }

    /**
     * Creates a new UaLeistungenEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public UaLeistungenEditor(final boolean boolEditor) {
    ...
    public void beforeSaving() {
        final RedundantObjectSearch leistSearch = new RedundantObjectSearch(
        ...
        try {
            ...
            LOG.warn("problem in check name leistung: load values.", e);
        }
    }
    ...
    public boolean isOkForSaving() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(UaLeistungenEditor.class, BUNDLE_NONAME));
                save = false;
            } else {
                if (redundantName) {
                    LOG.warn("Duplicate name specified. Skip persisting.");
                    errorMessage.append(NbBundle.getMessage(UaLeistungenEditor.class, BUNDLE_DUPLICATENAME));
                    save = false;
                }
            }
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(UaLeistungenEditor.class,
                    BUNDLE_PANE_PREFIX)
