 ...
 */
public class PrbrBuslinieEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    EditorSaveListener,
    BindingGroupStore,
    ...
    private static final Logger LOG = Logger.getLogger(PrbrBuslinieEditor.class);
    
    public static final String TABLE_NAME = "prbr_buslinie";
     ...
     * Creates new form.
     */
    public PrbrBuslinieEditor() {
    }

    /**
     * Creates a new PrbrBuslinieEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public PrbrBuslinieEditor(final boolean boolEditor) {
    ...
    public boolean prepareForSave() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(PrbrBuslinieEditor.class,
                        "PrbrBuslinieEditor.prepareForSave().noName"));
            }else {
                String myQuery;
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(PrbrBuslinieEditor.class,
                    "PrbrBuslinieEditor.prepareForSave().JOptionPane.message.prefix")
                        + errorMessage.toString()
                        + NbBundle.getMessage(PrbrBuslinieEditor.class,
                            "PrbrBuslinieEditor.prepareForSave().JOptionPane.message.suffix"),
            NbBundle.getMessage(PrbrBuslinieEditor.class,
                    "PrbrBuslinieEditor.prepareForSave().JOptionPane.title"),
