...
public class PoiConfProperties {
    ...
    private static final transient org.apache.log4j.Logger LOG = org.apache.log4j.Logger.getLogger(PoiConfProperties.class);
    ...
    /**
     * Creates a new PoiProperties object.
     *
     * @param  properties  DOCUMENT ME!
     */
    private PoiConfProperties(final Properties properties) {
        keyUrlLength = Integer.valueOf(readProperty(properties, "MAX_KEYURL_LENGTH", null));
        keyUrlPattern = String.valueOf(readProperty(properties, "KEYURL_PATTERN", null));
    }
    ...
    public static PoiConfProperties getInstance() {
        return PoiConfProperties.LazyInitialiser.INSTANCE;
    }
            ...
            try {
                ...
                final Object ret = SessionManager.getSession()
                            ...
                            .executeTask(user,
                                ...
                                "WUNDA_BLAU",
                                WundaBlauServerResources.POI_CONF_PROPERTIES.getValue(),
                                ConnectionContext.create(Category.STATIC, PoiConfProperties.class.getSimpleName()));
