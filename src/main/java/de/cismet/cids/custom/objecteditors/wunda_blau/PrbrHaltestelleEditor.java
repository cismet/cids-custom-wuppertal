 ...
 */
public class PrbrHaltestelleEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    EditorSaveListener,
    BindingGroupStore,
    ...
    private static final Logger LOG = Logger.getLogger(PrbrHaltestelleEditor.class);
    public static final String TABLE_NAME = "prbr_haltestelle";
     ...
     */
    public PrbrHaltestelleEditor(final boolean boolEditor) {
    ...
    public boolean prepareForSave() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(PrbrHaltestelleEditor.class,
                        "PrbrHaltestelleEditor.prepareForSave().noName"));
            }else {
                String myQuery;
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(PrbrHaltestelleEditor.class,
                    "PrbrHaltestelleEditor.prepareForSave().JOptionPane.message.prefix")
                        + errorMessage.toString()
                        + NbBundle.getMessage(PrbrHaltestelleEditor.class,
                            "PrbrHaltestelleEditor.prepareForSave().JOptionPane.message.suffix"),
            NbBundle.getMessage(PrbrHaltestelleEditor.class,
                    "PrbrHaltestelleEditor.prepareForSave().JOptionPane.title"),
