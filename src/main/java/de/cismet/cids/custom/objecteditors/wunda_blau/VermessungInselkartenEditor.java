 ...
 */
public class VermessungInselkartenEditor extends javax.swing.JPanel implements DisposableCidsBeanStore,
    ...
    private static final Logger LOG = Logger.getLogger(VermessungInselkartenEditor.class);
...
//    protected Object bezeichner;
    ...
    /**
     * Creates a new VermessungInselkartenEditor object.
     */
    public VermessungInselkartenEditor() {
        this(false);
    }

    /**
     * Creates new form VermessungInselkartenEditor.
     *
     * @param  readOnly  DOCUMENT ME!
     */
    public VermessungInselkartenEditor(final boolean readOnly) {
    ...
    public void initWithConnectionContext(final ConnectionContext connectionContext) {
        ...
        if (readOnly) {
            ...
            txtBlatt.setEditable(false);
            txtVersion.setEditable(false);
            txtFlur.setEditable(false);
        }
    }
    ...
    private void initComponents() {
        ...
        lblTitle.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.lblTitle.text")); // NOI18N
        ...
        warnMessage.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.warnMessage.text")); // NOI18N
        ...
        lblHeaderDocument.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.lblHeaderDocument.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.FIRST_LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 5);
        ...
        lblReducedSize.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.lblReducedSize.text_1")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        lblGeometrieStatus.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.lblGeometrieStatus.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        lblGeneralInformation.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.lblGeneralInformation.text")); // NOI18N
        ...
        lblGeometrie.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.lblGeometrie.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        ...
        lblGemarkung.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.lblGemarkung.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        ...
        lblFlur.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.lblFlur.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        ...
        lblVersion.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.lblVersion.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.FIRST_LINE_START;
        gridBagConstraints.insets = new java.awt.Insets(5, 10, 5, 5);
        pnlGeneralInformation.add(lblVersion, gridBagConstraints);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(
                org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE,
                this,
                org.jdesktop.beansbinding.ELProperty.create("${cidsBean.version}"),
                txtVersion,
        ...
        gridBagConstraints.weightx = 0.5;
        gridBagConstraints.insets = new java.awt.Insets(5, 5, 5, 7);
        pnlGeneralInformation.add(txtVersion, gridBagConstraints);

        lblBlatt.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.lblBlatt.text")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 2;
        gridBagConstraints.fill = java.awt.GridBagConstraints.BOTH;
        ...
        togPan.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.togPan.text"));                               // NOI18N
        togPan.setToolTipText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.togPan.toolTipText"));                        // NOI18N
        ...
        togZoom.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.togZoom.text"));                               // NOI18N
        togZoom.setToolTipText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.togZoom.toolTipText"));                        // NOI18N
        ...
        btnHome.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.btnHome.text"));                               // NOI18N
        btnHome.setToolTipText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.btnHome.toolTipText"));                        // NOI18N
        ...
        lblHeaderControls.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.lblHeaderControls.text")); // NOI18N
        ...
        btnOpen.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.btnOpen.text"));                                       // NOI18N
        btnOpen.setToolTipText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.btnOpen.toolTipText"));                                // NOI18N
        ...
        lblHeaderPages.setText(org.openide.util.NbBundle.getMessage(
                VermessungInselkartenEditor.class,
                "VermessungInselkartenEditor.lblHeaderPages.text")); // NOI18N
        ...
        CismetThreadPool.execute(new Runnable() {
                ...
                public void run() {
                    if (DownloadManagerDialog.getInstance().showAskingForUserTitleDialog(
                                    VermessungInselkartenEditor.this)) {
    ...
    private String getDocumentFilename() {
        ...
        final Integer flur = Integer.parseInt((String)cidsBean.getProperty("flur"));
        final Integer blatt = (Integer)cidsBean.getProperty("blatt");
        final String version = (String)cidsBean.getProperty("version");
        return VermessungPictureFinderClientUtils.getInstance()
                    .getInselkartenPictureFilename(
                        schluessel,
                        gemarkung,
                        flur,
                        blatt,
    ...
    private void checkLinkInTitle(final String document) {
        ...
        if (!readOnly && isUmleitung) {
            lblHeaderDocument.setText(NbBundle.getMessage(
                    VermessungInselkartenEditor.class,
                    "VermessungInselkartenEditor.lblHeaderDocument.text.inselkarte_umleitung"));
        } else {
            lblHeaderDocument.setText(NbBundle.getMessage(
                    VermessungInselkartenEditor.class,
                    "VermessungInselkartenEditor.lblHeaderDocument.text.inselkarte"));
        }
    }
...
//            bezeichner = cidsBean.getProperty("bezeichner");
    ...
    protected String generateTitle() {
        final String schluessel = (String)cidsBean.getProperty("schluessel");
        final String flur = (String)cidsBean.getProperty("flur");
        final Integer blatt = (Integer)cidsBean.getProperty("blatt");
        final String version = (String)cidsBean.getProperty("version");
        ...
        return new StringBuilder().append("Schlüssel ")
                    ...
                    .append(" - ")
                    .append("Gemarkung ")
                    .append((gemarkung != null) ? gemarkung : "unbekannt")
                    .append(" - ")
                    .append("Flur ")
                    .append((flur != null) ? flur : "unbekannt")
                    .append(" - ")
                    .append("Blatt ")
                    .append((blatt != null) ? blatt : "unbekannt")
                    .append(" - ")
                    .append("Version ")
                    .append((version != null) ? version : "unbekannt")
                    .toString();
    }
...
//                setCurrentDocumentNull();
        ...
        protected String doInBackground() throws Exception {
            ...
            return VermessungPictureFinderClientUtils.getInstance()
                        .findInselkartenPicture(schluessel, gemarkung, flur, blatt, version);
        }
