 ...
 */
public class EmobradLadekostenEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    EditorSaveListener,
    BindingGroupStore,
    ...
    public static final String FIELD__SCHLUESSEL = "schluessel";                    // emobrad_ladekosten
    ...
    /**
     * Creates a new EmobradLadekostenEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public EmobradLadekostenEditor(final boolean boolEditor) {
    ...
    public boolean prepareForSave() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(EmobradLadekostenEditor.class, BUNDLE_NONAME));
            } else {
                ...
                if (redundantName) {
                    ...
                    errorMessage.append(NbBundle.getMessage(EmobradLadekostenEditor.class, BUNDLE_DUPLICATENAME));
                } else {
                    if (redundantKey) {
                        LOG.warn("Duplicate key specified. Skip persisting.");
                        errorMessage.append(NbBundle.getMessage(EmobradLadekostenEditor.class, BUNDLE_DUPLICATEKEY));
                    } else {
                    }
                }
            }
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(EmobradLadekostenEditor.class,
                    BUNDLE_PANE_PREFIX)
