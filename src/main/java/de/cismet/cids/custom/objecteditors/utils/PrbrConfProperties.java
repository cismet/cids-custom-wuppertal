 ...
 */
@Getter
public class PrbrConfProperties {
     ...
     */
    private PrbrConfProperties(final Properties properties) {
     ...
     * @return  DOCUMENT ME!
     */
    public static PrbrConfProperties getInstance() {
        return PrbrConfProperties.LazyInitialiser.INSTANCE;
    }
    ...
    private static final class LazyInitialiser {
        ...
        private static final PrbrConfProperties INSTANCE;

        static {
            PrbrConfProperties instance = null;
            ...
            try {
                ...
                final Object ret = SessionManager.getSession()
                            ...
                            .executeTask(
                                ...
                                "WUNDA_BLAU",
                                WundaBlauServerResources.PRBR_CONF_PROPERTIES.getValue(),
                                ConnectionContext.create(Category.STATIC, PrbrConfProperties.class.getSimpleName()));
                if (ret instanceof Exception) {
                    throw (Exception)ret;
                }
                final Properties properties = new Properties();
                properties.load(new StringReader((String)ret));
                instance = new PrbrConfProperties(properties);
            } catch (final Exception ex) {
                LOG.error(ex, ex);
            }
