...
public class BaumGebietEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    ...
    private void lstMeldungenMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lstMeldungenMouseEntered
                                    ...
                                    if ((listErsatz != null) && !(listErsatz.isEmpty())) {
                                        for (final CidsBean ersatzBean : listErsatz) {
                                            try {
                                                ...
                                                LOG.error(
                                                    "Fehler bei der Speichervorbereitung der Ersatzpflanzungen.",
                                                    ex);
                                                JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                                                    NbBundle.getMessage(
