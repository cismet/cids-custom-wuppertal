 ...
 */
public class BaumTeilnehmerEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    EditorSaveListener,
    BindingGroupStore,
    ...
    private static final Logger LOG = Logger.getLogger(BaumTeilnehmerEditor.class);

    public static final String TABLE_NAME = "baum_teilnehmer";
    public static final String FIELD__NAME = "name";
    public static final String FIELD__SCHLUESSEL = "schluessel";
    public static final String FIELD__TELEFON = "telefon";
    public static final String FIELD__ID = "id";
    
    private static String titleNewTeilnehmer = "einen neuen Teilnehmer anlegen..."; 

    public static final String BUNDLE_NONAME = "BaumTeilnehmerEditor.prepareForSave().noName";
    public static final String BUNDLE_DUPLICATENAME = "BaumTeilnehmerEditor.prepareForSave().duplicateName";
    public static final String BUNDLE_DUPLICATEKEY = "BaumTeilnehmerEditor.prepareForSave().duplicateSchluessel";
    public static final String BUNDLE_PANE_PREFIX =
        "BaumTeilnehmerEditor.prepareForSave().JOptionPane.message.prefix";
    public static final String BUNDLE_PANE_SUFFIX =
        "BaumTeilnehmerEditor.prepareForSave().JOptionPane.message.suffix";
    public static final String BUNDLE_PANE_TITLE = "BaumTeilnehmerEditor.prepareForSave().JOptionPane.title";

    public static final String BUNDLE_HP_TITLE = "BaumTeilnehmerEditor.xhHomepageActionPerformed.title";
    public static final String BUNDLE_HP_TEXT = "BaumTeilnehmerEditor.xhHomepageActionPerformed.text";
     ...
     * Creates new form.
     */
    public BaumTeilnehmerEditor() {
    }

    /**
     * Creates a new BaumTeilnehmerEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public BaumTeilnehmerEditor(final boolean boolEditor) {
    ...
    public boolean prepareForSave() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(BaumTeilnehmerEditor.class, BUNDLE_NONAME));
            } else {
                ...
                if (redundantName) {
                    ...
                    errorMessage.append(NbBundle.getMessage(BaumTeilnehmerEditor.class, BUNDLE_DUPLICATENAME));
                } else {
                    if (redundantKey) {
                        LOG.warn("Duplicate key specified. Skip persisting.");
                        errorMessage.append(NbBundle.getMessage(BaumTeilnehmerEditor.class, BUNDLE_DUPLICATEKEY));
                    } else {
                    }
                }
            }
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(BaumTeilnehmerEditor.class,
                    BUNDLE_PANE_PREFIX)
                        + errorMessage.toString()
                        + NbBundle.getMessage(BaumTeilnehmerEditor.class,
                            BUNDLE_PANE_SUFFIX),
                NbBundle.getMessage(BaumTeilnehmerEditor.class, BUNDLE_PANE_TITLE),
    ...
    public void setCidsBean(final CidsBean cb) {
        ...
        try {
            if (isEditor && (this.cidsBean != null)) {
                LOG.info("remove propchange baum_teilnehmer: " + this.cidsBean);
                this.cidsBean.removePropertyChangeListener(this);
            }
            bindingGroup.unbind();
            this.cidsBean = cb;
            if (isEditor && (this.cidsBean != null)) {
                LOG.info("add propchange baum_teilnehmer: " + this.cidsBean);
