 ...
 */
public class BparkCityausweisbereichEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    SaveVetoable,
     ...
     * Creates new form.
     */
    public BparkCityausweisbereichEditor() {
        this(true);
    }

    /**
     * Creates a new BparkCityausweisbereichEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public BparkCityausweisbereichEditor(final boolean boolEditor) {
    ...
    private void initComponents() {
        ...
        panCitybereich.setOpaque(false);
        panCitybereich.setLayout(new GridBagLayout());
        ...
        lblBereich.setFont(new Font("Tahoma", 1, 11)); // NOI18N
        lblBereich.setText("Zone:");
        ...
        panDaten.add(txtBereich, gridBagConstraints);
        ...
        gridBagConstraints.weightx = 1.0;
        gridBagConstraints.weighty = 1.0;
        panCitybereich.add(jPanelAllgemein, gridBagConstraints);
        ...
        gridBagConstraints.weighty = 1.0;
        gridBagConstraints.insets = new Insets(10, 10, 10, 10);
        panContent.add(panCitybereich, gridBagConstraints);
    ...
    public void setCidsBean(final CidsBean cb) {
        try {
            ...
            this.cidsBean = cb;
            if (isEditor() && (getCidsBean() != null)) {
                LOG.info("add propchange bpark_cityausweisbereich: " + getCidsBean());
    ...
    private void setReadOnly() {
        if (!(isEditor())) {
            ...
            RendererTools.makeReadOnly(txtBereich);
    ...
    public boolean isOkForSaving() {
        ...
        // name vorhanden
        try {
            if (txtBereich.getText().trim().isEmpty()) {
                LOG.warn("No name specified. Skip persisting.");
                errorMessage.append(NbBundle.getMessage(BparkCityausweisbereichEditor.class, BUNDLE_NONAME));
                save = false;
            } else {
                if (redundantName) {
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(BparkCityausweisbereichEditor.class, BUNDLE_PANE_PREFIX)
                        + errorMessage.toString()
                        + NbBundle.getMessage(BparkCityausweisbereichEditor.class, BUNDLE_PANE_SUFFIX),
                NbBundle.getMessage(BparkCityausweisbereichEditor.class, BUNDLE_PANE_TITLE),
    ...
    public void beforeSaving() {
        ...
        conditions.add(FIELD__NAME + " ilike '" + txtBereich.getText().trim() + "'");
