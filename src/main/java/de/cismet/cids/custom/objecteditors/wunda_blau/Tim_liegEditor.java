...
public class Tim_liegEditor extends DefaultCustomObjectEditor implements Titled {
    ...
    private void initComponents() {
        ...
        tbpAdditionalInfo.addTab(" Stadtgrundkarte ", new javax.swing.ImageIcon(getClass().getResource("/de/cismet/cids/custom/objecteditors/wunda_blau/wbf_vorgang.png")), panStadtgrundkarte); // NOI18N
    ...
    private void cmdAddKartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddKartActionPerformed
        try {
    ...
    private void cmdAddSgkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdAddSgkActionPerformed
        try {
