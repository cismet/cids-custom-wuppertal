 ...
 */
public class TwMassnahmenEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    BeforeSavingHook,
    SaveVetoable,
    ...
    private static final Logger LOG = Logger.getLogger(TwMassnahmenEditor.class);
    public static final String REDUNDANT_TOSTRING_TEMPLATE = "%s";
    public static final String[] REDUNDANT_TOSTRING_FIELDS = { "name", "id" };
    public static final String REDUNDANT_TABLE = "tw_massnahmen";

    public static final String FIELD__NAME = "name";
    public static final String FIELD__ID = "id";
    public static final String TABLE_NAME = "tw_massnahmen";

    public static final String BUNDLE_NONAME = "TwMassnahmenEditor.isOkForSaving().noName";
    public static final String BUNDLE_DUPLICATENAME = "TwMassnahmenEditor.isOkForSaving().duplicateName";
    public static final String BUNDLE_PANE_PREFIX = "TwMassnahmenEditor.isOkForSaving().JOptionPane.message.prefix";
    public static final String BUNDLE_PANE_SUFFIX = "TwMassnahmenEditor.isOkForSaving().JOptionPane.message.suffix";
    public static final String BUNDLE_PANE_TITLE = "TwMassnahmenEditor.isOkForSaving().JOptionPane.title";
     ...
     */
    public TwMassnahmenEditor(final boolean boolEditor) {
    ...
    public void beforeSaving() {
        ...
        try {
            ...
            LOG.warn("problem in check name massnahme: load values.", e);
        }
    }
    ...
    public boolean isOkForSaving() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(TwMassnahmenEditor.class, BUNDLE_NONAME));
                save = false;
            } else {
                if (redundantName) {
                    LOG.warn("Duplicate name specified. Skip persisting.");
                    errorMessage.append(NbBundle.getMessage(TwMassnahmenEditor.class, BUNDLE_DUPLICATENAME));
                    save = false;
                }
            }
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(TwMassnahmenEditor.class,
                    BUNDLE_PANE_PREFIX)
