 ...
 */
public class VkNutzungEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    BeforeSavingHook,
    SaveVetoable,
    ...
    private static final Logger LOG = Logger.getLogger(VkNutzungEditor.class);
    public static final String REDUNDANT_TOSTRING_TEMPLATE = "%s";
    public static final String[] REDUNDANT_TOSTRING_FIELDS = { "name", "id" };
    public static final String REDUNDANT_TABLE = "vk_nutzung";

    public static final String TABLE_NAME = "vk_nutzung";
    public static final String FIELD__NAME = "name";
    public static final String FIELD__ID = "id";

    private static String TITLE_NEW_NUTZUNG = "eine neue Nutzung anlegen...";

    public static final String BUNDLE_NONAME = "VkNutzungEditor.isOkForSaving().noName";
    public static final String BUNDLE_DUPLICATENAME = "VkNutzungEditor.isOkForSaving().duplicateName";
    public static final String BUNDLE_NOTEXT = "VkNutzungEditor.isOkForSaving().noText";
    public static final String BUNDLE_PANE_PREFIX = "VkNutzungEditor.isOkForSaving().JOptionPane.message.prefix";
    public static final String BUNDLE_PANE_SUFFIX = "VkNutzungEditor.isOkForSaving().JOptionPane.message.suffix";
    public static final String BUNDLE_PANE_TITLE = "VkNutzungEditor.isOkForSaving().JOptionPane.title";
     ...
     * Creates new form.
     */
    public VkNutzungEditor() {
        this(true);
    }

    /**
     * Creates a new VkNutzungEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public VkNutzungEditor(final boolean boolEditor) {
    ...
    public boolean isOkForSaving() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(VkNutzungEditor.class, BUNDLE_NONAME));
                save = false;
            } else {
                if (redundantName) {
                    LOG.warn("Duplicate name specified. Skip persisting.");
                    errorMessage.append(NbBundle.getMessage(VkNutzungEditor.class, BUNDLE_DUPLICATENAME));
                    save = false;
                }
            }
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(VkNutzungEditor.class,
                    BUNDLE_PANE_PREFIX)
                        + errorMessage.toString()
                        + NbBundle.getMessage(VkNutzungEditor.class,
                            BUNDLE_PANE_SUFFIX),
                NbBundle.getMessage(VkNutzungEditor.class, BUNDLE_PANE_TITLE),
