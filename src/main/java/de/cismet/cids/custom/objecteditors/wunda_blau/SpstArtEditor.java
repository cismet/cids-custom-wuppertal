 ...
 */
public class SpstArtEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    BeforeSavingHook,
    SaveVetoable,
    ...
    private static final Logger LOG = Logger.getLogger(SpstArtEditor.class);
    public static final String REDUNDANT_TOSTRING_TEMPLATE = "%s";
    public static final String[] REDUNDANT_TOSTRING_FIELDS = { "name", "id" };
    public static final String REDUNDANT_TABLE = "spst_art";

    public static final String TABLE_NAME = "spst_art";
    public static final String FIELD__NAME = "name";
    public static final String FIELD__ID = "id";

    private static String TITLE_NEW_ART = "eine neue Sportanlagen-Art anlegen...";

    public static final String BUNDLE_NONAME = "SpstArtEditor.isOkForSaving().noName";
    public static final String BUNDLE_DUPLICATENAME = "SpstArtEditor.isOkForSaving().duplicateName";
    public static final String BUNDLE_NONUMBER = "SpstArtEditor.isOkForSaving().noNumber";
    public static final String BUNDLE_PANE_PREFIX = "SpstArtEditor.isOkForSaving().JOptionPane.message.prefix";
    public static final String BUNDLE_PANE_SUFFIX = "SpstArtEditor.isOkForSaving().JOptionPane.message.suffix";
    public static final String BUNDLE_PANE_TITLE = "SpstArtEditor.isOkForSaving().JOptionPane.title";
     ...
     * Creates new form.
     */
    public SpstArtEditor() {
        this(true);
    }

    /**
     * Creates a new SpstArtEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public SpstArtEditor(final boolean boolEditor) {
    ...
    public boolean isOkForSaving() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(SpstArtEditor.class, BUNDLE_NONAME));
                save = false;
            } else {
                if (redundantName) {
                    LOG.warn("Duplicate name specified. Skip persisting.");
                    errorMessage.append(NbBundle.getMessage(SpstArtEditor.class, BUNDLE_DUPLICATENAME));
                    save = false;
                }
            }
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(SpstArtEditor.class,
                    BUNDLE_PANE_PREFIX)
                        + errorMessage.toString()
                        + NbBundle.getMessage(SpstArtEditor.class,
                            BUNDLE_PANE_SUFFIX),
                NbBundle.getMessage(SpstArtEditor.class, BUNDLE_PANE_TITLE),
