...
public class BaumMassnahmeEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    ...
    /**
     * Creates a new BaumMassnahmeEditor object.
     *
    ...
    public boolean prepareForSave() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(BaumMassnahmeEditor.class, BUNDLE_NONAME));
            } else {
                if (redundantName) {
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(BaumMassnahmeEditor.class,
                    BUNDLE_PANE_PREFIX)
                        + errorMessage.toString()
                        + NbBundle.getMessage(BaumMassnahmeEditor.class,
                            BUNDLE_PANE_SUFFIX),
                NbBundle.getMessage(BaumMassnahmeEditor.class, BUNDLE_PANE_TITLE),
