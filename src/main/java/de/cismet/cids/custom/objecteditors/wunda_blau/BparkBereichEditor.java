 ...
 */
public class BparkBereichEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    SaveVetoable,
    ...
    public static final String BUNDLE_NOZONE = "BparkBereichEditor.isOkForSaving().noZone";
    public static final String BUNDLE_NOGEOM = "BparkBereichEditor.isOkForSaving().noGeom";
     ...
     * Creates new form.
     */
    public BparkBereichEditor() {
        this(true);
    }

    /**
     * Creates a new BparkBereichEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public BparkBereichEditor(final boolean boolEditor) {
    ...
    private void initComponents() {
        ...
        panDaten.add(cbZone, gridBagConstraints);
    ...
    public void setCidsBean(final CidsBean cb) {
        try {
            ...
            this.cidsBean = cb;
            if (isEditor() && (getCidsBean() != null)) {
                LOG.info("add propchange bpark_bereich: " + getCidsBean());
    ...
    public boolean isOkForSaving() {
        ...
        // zone
        try {
            if (getCidsBean().getProperty(FIELD__ZONE) == null) {
                LOG.warn("No zone specified. Skip persisting.");
                errorMessage.append(NbBundle.getMessage(BparkBereichEditor.class, BUNDLE_NOZONE));
                save = false;
            }
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(BparkBereichEditor.class, BUNDLE_PANE_PREFIX)
                        + errorMessage.toString()
                        + NbBundle.getMessage(BparkBereichEditor.class, BUNDLE_PANE_SUFFIX),
                NbBundle.getMessage(BparkBereichEditor.class, BUNDLE_PANE_TITLE),
