 ...
 */
public class EmobrentLeihgebuehrEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    EditorSaveListener,
    BindingGroupStore,
     ...
     * Creates new form.
     */
    public EmobrentLeihgebuehrEditor() {
    }

    /**
     * Creates a new EmobrentLeihgebuehrEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public EmobrentLeihgebuehrEditor(final boolean boolEditor) {
    ...
    public boolean prepareForSave() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(EmobrentLeihgebuehrEditor.class, BUNDLE_NONAME));
            } else {
                ...
                if (redundantName) {
                    ...
                    errorMessage.append(NbBundle.getMessage(EmobrentLeihgebuehrEditor.class, BUNDLE_DUPLICATENAME));
                } else {
                    if (redundantKey) {
                        LOG.warn("Duplicate key specified. Skip persisting.");
                        errorMessage.append(NbBundle.getMessage(EmobrentLeihgebuehrEditor.class, BUNDLE_DUPLICATEKEY));
                    } else {
                    }
                }
            }
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(EmobrentLeihgebuehrEditor.class,
                    BUNDLE_PANE_PREFIX)
