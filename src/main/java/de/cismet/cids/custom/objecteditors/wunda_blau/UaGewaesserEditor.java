 ...
 */
public class UaGewaesserEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    BeforeSavingHook,
    SaveVetoable,
    ...
    private static final Logger LOG = Logger.getLogger(UaGewaesserEditor.class);
    ...
    public static final String BUNDLE_DUPLICATENAME = "UaGewaesserEditor.isOkForSaving().duplicateName";
    public static final String BUNDLE_PANE_PREFIX = "UaGewaesserEditor.isOkForSaving().JOptionPane.message.prefix";
    public static final String BUNDLE_PANE_SUFFIX = "UaGewaesserEditor.isOkForSaving().JOptionPane.message.suffix";
    public static final String BUNDLE_PANE_TITLE = "UaGewaesserEditor.isOkForSaving().JOptionPane.title";
    private static String TITLE_NEW_GEW = "eine neues Gewässer anlegen...";
     ...
     * Creates new form.
     */
    public UaGewaesserEditor() {
        this(true);
    }

    /**
     * Creates a new UaGewaesserEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public UaGewaesserEditor(final boolean boolEditor) {
    ...
    public void beforeSaving() {
        final RedundantObjectSearch gewSearch = new RedundantObjectSearch(
        ...
        try {
            ...
            LOG.warn("problem in check name gewaesser: load values.", e);
        }
    }
    ...
    public boolean isOkForSaving() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(UaGewaesserEditor.class, BUNDLE_NONAME));
                save = false;
            } else {
                if (redundantName) {
                    LOG.warn("Duplicate name specified. Skip persisting.");
                    errorMessage.append(NbBundle.getMessage(UaGewaesserEditor.class, BUNDLE_DUPLICATENAME));
                    save = false;
                }
            }
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(UaGewaesserEditor.class,
                    BUNDLE_PANE_PREFIX)
    ...
    private void initComponents() {
        ...
        lblWv.setFont(new Font("Tahoma", 1, 11)); // NOI18N
        lblWv.setText("WV:");
        gridBagConstraints = new GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 1;
        ...
        gridBagConstraints.anchor = GridBagConstraints.WEST;
        gridBagConstraints.insets = new Insets(2, 0, 2, 5);
        panName.add(lblWv, gridBagConstraints);
        ...
        gridBagConstraints.anchor = GridBagConstraints.WEST;
        gridBagConstraints.insets = new Insets(2, 2, 2, 2);
        panName.add(chWv, gridBagConstraints);
    ...
    private void setReadOnly() {
        if (!(isEditor())) {
            ...
            RendererTools.makeReadOnly(chWv);
        }
    }
