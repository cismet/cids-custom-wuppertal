 ...
 */
public class EmobZugangsartEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    EditorSaveListener,
    BindingGroupStore,
    ...
    /**
     * Creates a new EmobZugangsartEditor object.
     *
     * @param  boolEditor  DOCUMENT ME!
     */
    public EmobZugangsartEditor(final boolean boolEditor) {
    ...
    public boolean prepareForSave() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(EmobZugangsartEditor.class, BUNDLE_NONAME));
            } else {
                ...
                if (redundantName) {
                    ...
                    errorMessage.append(NbBundle.getMessage(EmobZugangsartEditor.class, BUNDLE_DUPLICATENAME));
                } else {
                    if (redundantKey) {
                        LOG.warn("Duplicate key specified. Skip persisting.");
                        errorMessage.append(NbBundle.getMessage(EmobZugangsartEditor.class, BUNDLE_DUPLICATEKEY));
                    } else {
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(EmobZugangsartEditor.class, BUNDLE_PANE_PREFIX)
                        + errorMessage.toString()
                        + NbBundle.getMessage(EmobZugangsartEditor.class, BUNDLE_PANE_SUFFIX),
                NbBundle.getMessage(EmobZugangsartEditor.class, BUNDLE_PANE_TITLE),
