    ...
    public boolean prepareForSave() {
        ...
        try {
            if (txtName.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(EmobSteckdosentypEditor.class,
                        "EmobZugangsartEditor.prepareForSave().noName"));
            } else {
        ...
        if (errorMessage.length() > 0) {
            JOptionPane.showMessageDialog(StaticSwingTools.getParentFrame(this),
                NbBundle.getMessage(EmobZugangsartEditor.class,
                    "EmobZugangsartEditor.prepareForSave().JOptionPane.message.prefix")
                        + errorMessage.toString()
                        + NbBundle.getMessage(EmobZugangsartEditor.class,
                            "EmobZugangsartEditor.prepareForSave().JOptionPane.message.suffix"),
                NbBundle.getMessage(EmobZugangsartEditor.class,
                    "EmobZugangsartEditor.prepareForSave().JOptionPane.title"),
