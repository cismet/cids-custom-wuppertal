...
public class BaumWurzelEditor extends DefaultCustomObjectEditor implements CidsBeanRenderer,
    ...
    public static final String BUNDLE_NONUMBER = "BaumWurzelEditor.isOkForSaving().noNumber";
    ...
    public boolean isOkForSaving() {
        ...
        try {
            if (txtNummer.getText().trim().isEmpty()) {
                ...
                errorMessage.append(NbBundle.getMessage(BaumWurzelEditor.class, BUNDLE_NONUMBER));
                save = false;
            }
        } catch (final MissingResourceException ex) {
