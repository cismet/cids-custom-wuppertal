...
//    private Collection<CidsBean> baulastenBeansToDelete = new ArrayList<CidsBean>();
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, panBaulastEditor, org.jdesktop.beansbinding.ELProperty.create("${cidsBean.bearbeitungsdatum}"), jLabel4, org.jdesktop.beansbinding.BeanProperty.create("text"), "bearbeitungsdatum");
        ...
        jLabel5.setText("durch");
        jPanel1.add(jLabel5);

        jLabel6.setForeground(new java.awt.Color(204, 204, 204));

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, panBaulastEditor, org.jdesktop.beansbinding.ELProperty.create("${cidsBean.bearbeitet_von}"), jLabel6, org.jdesktop.beansbinding.BeanProperty.create("text"), "bearbeitet_von");
        binding.setSourceNullValue("(unbekannt)");
        binding.setSourceUnreadableValue("(unbekannt)");
        bindingGroup.addBinding(binding);
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${cidsBean.blattnummer}"), txtBlattnummer, org.jdesktop.beansbinding.BeanProperty.create("text"));
